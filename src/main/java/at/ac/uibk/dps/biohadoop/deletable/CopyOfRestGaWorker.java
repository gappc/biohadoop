...
public class CopyOfRestGaWorker implements WorkerConnection {

	private static final Logger LOG = LoggerFactory
			.getLogger(CopyOfRestGaWorker.class);

	private static String className = Helper.getClassname(CopyOfRestGaWorker.class);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		LOG.info("############# {} client calls master at: {}:{} #############",
				className, host, port);
		new CopyOfRestGaWorker(host, port);
		LOG.info("############# {} stopped #############", className);
	}
	
	public CopyOfRestGaWorker() {
	}
	...
	public CopyOfRestGaWorker(String masterHostname, int port) {
