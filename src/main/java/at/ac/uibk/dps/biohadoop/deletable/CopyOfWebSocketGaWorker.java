...
public class CopyOfWebSocketGaWorker implements WorkerConnection {

	private static final Logger LOG = LoggerFactory
			.getLogger(CopyOfWebSocketGaWorker.class);
	...
	public static void main(String[] args) throws Exception {
		LOG.info("############# {} started ##############",
				CopyOfWebSocketGaWorker.class.getSimpleName());
		...
		LOG.info(
				...
				url);
		new CopyOfWebSocketGaWorker(URI.create(url));
	}
	
	public CopyOfWebSocketGaWorker() {
	}
	...
	public CopyOfWebSocketGaWorker(URI uri) throws DeploymentException, IOException,
