...
public class MessageConverter {
	...
	public static <T> Message<ClassNameWrapper<T>> getMessageForMethod(
			String data, String methodName, int pos) throws ConversionException {
		try {
			JsonNode node = objectMapper.readTree(data);
			String messageType = ((TextNode) node.findValue("type"))
					.asText();
