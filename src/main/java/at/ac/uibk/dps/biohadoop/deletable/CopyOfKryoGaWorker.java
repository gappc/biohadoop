...
public class CopyOfKryoGaWorker implements WorkerConnection {

	private static final Logger LOG = LoggerFactory
			.getLogger(CopyOfKryoGaWorker.class);
	...
	public static void main(String[] args) throws Exception {
		LOG.info("############# {} started ##############",
				CopyOfKryoGaWorker.class.getSimpleName());
		...
		LOG.info("######### {} client calls master at: {}:{}",
				CopyOfKryoGaWorker.class.getSimpleName(), host, port);
		new CopyOfKryoGaWorker(host, port);
	}
	
	public CopyOfKryoGaWorker() {
	}
	...
	public CopyOfKryoGaWorker(String hostname, int port) throws DeploymentException,
