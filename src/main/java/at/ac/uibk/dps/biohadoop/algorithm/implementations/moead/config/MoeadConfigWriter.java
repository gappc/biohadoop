package at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.config;
...
import at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.communication.master.MoeadKryo;
import at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.communication.master.MoeadLocal;
import at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.communication.master.MoeadRest;
import at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.communication.master.MoeadSocket;
import at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.communication.master.MoeadWebSocket;
import at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.communication.worker.LocalMoeadWorker;
import at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.communication.worker.SocketMoeadWorker;
import at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.communication.worker.WebSocketMoeadWorker;
import at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.distribution.MoeadBestResultGetter;
import at.ac.uibk.dps.biohadoop.algorithm.implementations.moead.distribution.MoeadSimpleMerger;
